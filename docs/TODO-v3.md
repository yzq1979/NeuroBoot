...
> **🚨 重要：2026-05-25 v3.0 计划已重新校准（用户痛点 + AI agent 能力驱动）**
> v3.0 当前进度详见 **[TODO-v3.0.md](TODO-v3.0.md)** —— Sprint 2 原计划已替换，
> 重点改为「让 AI 把 22 工具用得更准」+「7 个高频用户痛点 skill」。本文档保留作为
> 历史 / 全景路线参考。
>
> **关联文档**：
> - **当前 v3.0 进度**：[TODO-v3.0.md](TODO-v3.0.md) ← 下次开工先看这个
